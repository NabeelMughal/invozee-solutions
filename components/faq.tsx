          ...
          {faqs.map((faq, index) => (
            ...
            >
              <button
                ...
                className="w-full px-6 py-4 flex items-center justify-between bg-white dark:bg-[#1a2a3a] hover:bg-gray-50/80 dark:hover:bg-[#1a2a3a]/80 transition-colors duration-200 text-left"
